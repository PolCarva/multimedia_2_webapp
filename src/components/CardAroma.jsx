...
const CardAroma = ({ setConfig, config }) => {
  const handleFromTimeChange = (e) => {
    setConfig((prevConfig) => ({
      ...prevConfig,
      aroma: { ...prevConfig.aroma, desde: parseInt(e.target.value) },
    }));
  };

  const handleAromaHasta = (e) => {
    setConfig((prevConfig) => ({
      ...prevConfig,
      aroma: { ...prevConfig.aroma, hasta: parseInt(e.target.value) },
    }));
  };
